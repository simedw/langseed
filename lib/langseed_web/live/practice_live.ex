defmodule LangseedWeb.PracticeLive do
  ...
  # ============================================================================
  # PRIVATE HELPERS - Pinyin/Kana Matching
  # ============================================================================
  ...
  # Generate audio URL for question (handles all question types)
  # Uses full generation path - checks if audio exists, generates if missing.
