defmodule LangseedWeb.PracticeLive do
  ...
  # Get audio URL for question (handles all question types)
  # Uses optimistic path - skips existence check for instant response.
  # Audio should already be pre-generated by QuestionGenerator worker.
  defp generate_audio_for_question(socket, question) do
    ...
    start_async(socket, :generate_audio, fn ->
      Langseed.Audio.get_sentence_audio_url(sentence, language)
    end)
  end
